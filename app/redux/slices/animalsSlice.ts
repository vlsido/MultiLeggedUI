...
export const animalsSlice = createSlice({
  ...
  initialState,
  reducers: {
    setCategoriesAnimals: (
      state, action: PayloadAction<CategoryAnimals[]>
    ) => {
...
export const {
  setCategoriesAnimals,
  clearCategoriesAnimals,
} = animalsSlice.actions;

export const selectCategoriesAnimals = (state: RootState) => state.animals.categoriesAnimals;
